...
class _AuthService implements AuthService {
  ...
  Future<HttpResponse<PinResponseModel>> setPin(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(setPinRequestModel.toJson());
    final _options = _setStreamType<HttpResponse<PinResponseModel>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'Auth/set-pin',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PinResponseModel _value;
    try {
      _value = PinResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
